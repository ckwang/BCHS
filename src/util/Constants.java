...
public class Constants {
	...
	public static final int NINE_FLUSH = EIGHT_FLUSH + SEVEN_FLUSH + SIX_FLUSH
			+ FIVE_FLUSH + FOUR_FLUSH + THREE_FLUSH + TWO_FLUSH + 1;
	public static final int TEN_FLUSH = NINE_FLUSH + EIGHT_FLUSH + SEVEN_FLUSH
			+ SIX_FLUSH + FIVE_FLUSH + FOUR_FLUSH + THREE_FLUSH + 1;
	public static final int JACK_FLUSH = TEN_FLUSH + NINE_FLUSH + EIGHT_FLUSH
			+ SEVEN_FLUSH + SIX_FLUSH + FIVE_FLUSH + FOUR_FLUSH + 1;
	public static final int QUEEN_FLUSH = JACK_FLUSH + TEN_FLUSH + NINE_FLUSH
			+ EIGHT_FLUSH + SEVEN_FLUSH + SIX_FLUSH + FIVE_FLUSH + 1;
	public static final int KING_FLUSH = QUEEN_FLUSH + JACK_FLUSH + TEN_FLUSH
			+ NINE_FLUSH + EIGHT_FLUSH + SEVEN_FLUSH + SIX_FLUSH + 1;
	public static final int ACE_FLUSH = KING_FLUSH + QUEEN_FLUSH + JACK_FLUSH
			+ TEN_FLUSH + NINE_FLUSH + EIGHT_FLUSH + SEVEN_FLUSH + 1;

	public static final int MAX_FIVE_NONFLUSH_KEY_INT = 4 * ACE_FIVE
			+ KING_FIVE;
	public static final int MAX_SEVEN_FLUSH_KEY_INT = ACE_FLUSH + KING_FLUSH
			+ QUEEN_FLUSH + JACK_FLUSH + TEN_FLUSH + NINE_FLUSH + EIGHT_FLUSH;
	...
	public static final int MAX_FLUSH_KEY_INT = ACE_FLUSH + KING_FLUSH
			+ QUEEN_FLUSH + JACK_FLUSH + TEN_FLUSH + NINE_FLUSH + EIGHT_FLUSH;
	public static final int MAX_KEY_INT = MAX_NONFLUSH_KEY_INT
			+ MAX_FLUSH_KEY_INT;
	...
	public static final int MAX_NUMBER_OF_TABLE_CARDS = 5;
